...
Examples:
  ...
  antigine feature show <id>        Show feature details
    ...
    init_parser = subparsers.add_parser(
        "init", 
        help="Initialize a new Antigine project"
    )
    ...
    list_parser.add_argument(
        "--status",
        help="Filter by status (requested, planned, in_progress, implemented, validated, superseded)"
    )
    list_parser.add_argument(
        "--type",
        help="Filter by type (new_feature, bug_fix, refactor, enhancement)"
    )
    
    # Feature show
    show_parser = feature_subparsers.add_parser(
        "show",
        help="Show detailed feature information"
    )
    show_parser.add_argument(
        "feature_id",
        help="Feature ID to show details for"
    )

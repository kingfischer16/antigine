...
def TECH_ARCHITECT_REVIEWER_SYSTEM_PROMPT(engine_or_framework: str, prog_language: str) -> str:
  ...
  return (
    ...
    "\n"
    "**Feasibility Check:**\n"
    " - Are the proposed components appropriate for the " + engine_or_framework + " and the " + prog_language + " language?\n"
    ...
    " - 'feasibility_score' (int): [1-5, where 5 = fully feasible in " + engine_or_framework + "/" + prog_language + "],\n"
...
def FIP_REVIEWER_SYSTEM_PROMPT(engine_or_framework: str, prog_language: str) -> str:
  ...
  return (
    ...
    " 4. Does the FIP correctly and efficiently make use of the " + engine_or_framework + " and " + prog_language + " features?\n"
    "\n"
    "Your response must comply with this output structure:\n"

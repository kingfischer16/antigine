...
class TestInitHelperFunctions(unittest.TestCase):
    ...
    def test_get_programming_language_interactive(self, mock_prompt):
        ...
        mock_prompt.assert_called_once_with(
            "Select programming language", choices=["Lua", "Python", "C++", "C"], default=None
        )
...
class TestInitCommandIntegration(unittest.TestCase):
    ...
    def test_handle_init_with_command_line_args(
        self, mock_detect, mock_get_lang, mock_get_tech, mock_resolve, mock_manager
    ):
    ...
    def test_handle_init_interactive_mode(
        self, mock_prompt_input, mock_detect, mock_get_lang, mock_get_tech, mock_resolve, mock_manager
    ):
